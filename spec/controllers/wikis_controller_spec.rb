  ...
  context "standard user" do
    ...
    describe "POST create" do
      it "increases the number of wikis by 1" do
        expect{ post :create, wiki: {title: RandomData.random_sentence, body: RandomData.random_paragraph, private: false}, users: { id: [other_user.id] } }.to change(Wiki,:count).by(1)
      end

      it "assigns Wiki.last to @wiki" do
        post :create, wiki: {title: RandomData.random_sentence, body: RandomData.random_paragraph, private: false}, users: { id: [other_user.id] }
    ...
    describe "PUT update" do
      it "updates wiki with expected attributes and doesnt allow private" do
        ...
        put :update, id: my_wiki.id, wiki: {title: new_title, body: new_body, private: new_private}, users: { id: [] }, collabs: { id: [my_collaborator.id] }
